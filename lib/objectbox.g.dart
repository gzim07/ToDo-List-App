...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 6429396691746662993),
      name: 'TodoEntity',
      lastPropertyId: const IdUid(5, 8073197614408567161),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 2961951888908041967),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 3010189595812489735),
            name: 'task_title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 8092162221377120938),
            name: 'task_desciption',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 7217319267758062974),
            name: 'task_done',
            type: 1,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 8073197614408567161),
            name: 'creation_date',
            type: 10,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 6429396691746662993),
  ...
  final bindings = <Type, EntityDefinition>{
    TodoEntity: EntityDefinition<TodoEntity>(
        ...
        objectToFB: (TodoEntity object, fb.Builder fbb) {
          ...
          final task_desciptionOffset = object.task_desciption == null
              ? null
              : fbb.writeString(object.task_desciption!);
          fbb.startTable(6);
          fbb.addInt64(0, object.id);
          fbb.addOffset(1, task_titleOffset);
          fbb.addOffset(2, task_desciptionOffset);
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = TodoEntity(
              ...
              task_desciption: const fb.StringReader(asciiOptimization: true)
...
class TodoEntity_ {
  ...
  /// see [TodoEntity.task_desciption]
  static final task_desciption =
